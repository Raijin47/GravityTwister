...
public class Slot : MonoBehaviour
{
    ...
    public float Offset => Game.Locator.SpinController.Offset;
    private const float EndSpeed = 400;
    private const float MinSpeed = 200;
    private const float TimeSpin = 5f;
    ...
    private IEnumerator SpinProcess()
    {
        ...
        IsActive = false;
        Game.Locator.SpinController.GetResult();
    }
